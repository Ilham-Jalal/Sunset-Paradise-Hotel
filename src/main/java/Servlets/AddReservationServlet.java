...
public class AddReservationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Date parsedStartDate = dateFormat.parse(startDateS);
            Date parsedEndDate = dateFormat.parse(endDateS);
            ...
            e.printStackTrace();
            response.getWriter().println("Error creating reservation: " + e.getMessage());
        }
    }
}
